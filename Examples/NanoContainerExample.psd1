@{
    AllNodes = @(
        ...
        @{
            ...
            IPAddress = '10.0.0.10';
            Lability_Media = '2016_x64_Datacenter_Nano_Container_EN_Eval';
        ...
        Lability = @{
            Media = (
                @{
                    ...
                    Id              = '2016_x64_Datacenter_Nano_Container_EN_Eval';
                    Filename        = '2016_x64_EN_Eval.iso';
                    Description     = 'Windows Server 2016 Datacenter Nano Container Host 64bit English Evaluation';
                    Architecture    = 'x64';
