Describe 'NewLabVM Tests' {

   Context 'Parameters for NewLabVM'{
        ...
        It 'Has a Parameter called IsQuickVM' {
            $Function.Parameters.Keys.Contains('IsQuickVM') | Should Be 'True'
            }
        It 'IsQuickVM Parameter is Identified as Mandatory being False' {
            [String]$Function.Parameters.IsQuickVM.Attributes.Mandatory | Should be 'False'
            }
        It 'IsQuickVM Parameter is of SwitchParameter Type' {
            $Function.Parameters.IsQuickVM.ParameterType.FullName | Should be 'System.Management.Automation.SwitchParameter'
            }
        It 'IsQuickVM Parameter is member of ParameterSets' {
            [String]$Function.Parameters.IsQuickVM.ParameterSets.Keys | Should Be '__AllParameterSets'
            }
        It 'IsQuickVM Parameter Position is defined correctly' {
            [String]$Function.Parameters.IsQuickVM.Attributes.Position | Should be '-2147483648'
            }
        It 'Does IsQuickVM Parameter Accept Pipeline Input?' {
            [String]$Function.Parameters.IsQuickVM.Attributes.ValueFromPipeline | Should be 'False'
            }
        It 'Does IsQuickVM Parameter Accept Pipeline Input by PropertyName?' {
            [String]$Function.Parameters.IsQuickVM.Attributes.ValueFromPipelineByPropertyName | Should be 'True'
            }
        It 'Does IsQuickVM Parameter use advanced parameter Validation? ' {
            $Function.Parameters.IsQuickVM.Attributes.TypeID.Name -contains 'ValidateNotNullOrEmptyAttribute' | Should Be 'False'
            $Function.Parameters.IsQuickVM.Attributes.TypeID.Name -contains 'ValidateNotNullAttribute' | Should Be 'False'
            $Function.Parameters.IsQuickVM.Attributes.TypeID.Name -contains 'ValidateScript' | Should Be 'False'
            $Function.Parameters.IsQuickVM.Attributes.TypeID.Name -contains 'ValidateRangeAttribute' | Should Be 'False'
            $Function.Parameters.IsQuickVM.Attributes.TypeID.Name -contains 'ValidatePatternAttribute' | Should Be 'False'
            }
        It 'Has Parameter Help Text for IsQuickVM '{
            $function.Definition.Contains('.PARAMETER IsQuickVM') | Should Be 'True'
            }
    }
