Describe 'ConvertToConfigurationData Tests' {

   Context 'Parameters for ConvertToConfigurationData'{
        ...
        It 'ConfigurationData Parameter is of String Type' {
            $Function.Parameters.ConfigurationData.ParameterType.FullName | Should be 'System.String'
            }
