Describe 'ResolvePSGalleryModuleUri Tests' {

   Context 'Parameters for ResolvePSGalleryModuleUri'{
        ...
        It 'MinimumVersion Parameter Position is defined correctly' {
            [String]$Function.Parameters.MinimumVersion.Attributes.Position | Should be '1'
            }
        ...
        It 'RequiredVersion Parameter is Identified as Mandatory being False' {
            [String]$Function.Parameters.RequiredVersion.Attributes.Mandatory | Should be 'False'
            }
        ...
        It 'RequiredVersion Parameter is member of ParameterSets' {
            [String]$Function.Parameters.RequiredVersion.ParameterSets.Keys | Should Be '__AllParameterSets'
            }
        It 'RequiredVersion Parameter Position is defined correctly' {
            [String]$Function.Parameters.RequiredVersion.Attributes.Position | Should be '2'
            }
        ...
        It 'Uri Parameter Position is defined correctly' {
            [String]$Function.Parameters.Uri.Attributes.Position | Should be '3'
            }
        ...
        It 'RemainingArguments Parameter Position is defined correctly' {
            [String]$Function.Parameters.RemainingArguments.Attributes.Position | Should be '4'
            }
