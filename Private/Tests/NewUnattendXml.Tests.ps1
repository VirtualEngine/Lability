Describe 'NewUnattendXml Tests' {

   Context 'Parameters for NewUnattendXml'{
        ...
        It 'Credential Parameter Position is defined correctly' {
            [String]$Function.Parameters.Credential.Attributes.Position | Should be '0'
            }
        ...
        It 'ComputerName Parameter Position is defined correctly' {
            [String]$Function.Parameters.ComputerName.Attributes.Position | Should be '1'
            }
        ...
        It 'ProductKey Parameter Position is defined correctly' {
            [String]$Function.Parameters.ProductKey.Attributes.Position | Should be '2'
            }
        ...
        It 'InputLocale Parameter Position is defined correctly' {
            [String]$Function.Parameters.InputLocale.Attributes.Position | Should be '3'
            }
        ...
        It 'SystemLocale Parameter Position is defined correctly' {
            [String]$Function.Parameters.SystemLocale.Attributes.Position | Should be '4'
            }
        ...
        It 'UserLocale Parameter Position is defined correctly' {
            [String]$Function.Parameters.UserLocale.Attributes.Position | Should be '5'
            }
        ...
        It 'UILanguage Parameter Position is defined correctly' {
            [String]$Function.Parameters.UILanguage.Attributes.Position | Should be '6'
            }
        ...
        It 'Timezone Parameter Position is defined correctly' {
            [String]$Function.Parameters.Timezone.Attributes.Position | Should be '7'
            }
        ...
        It 'RegisteredOwner Parameter Position is defined correctly' {
            [String]$Function.Parameters.RegisteredOwner.Attributes.Position | Should be '8'
            }
        ...
        It 'RegisteredOrganization Parameter Position is defined correctly' {
            [String]$Function.Parameters.RegisteredOrganization.Attributes.Position | Should be '9'
            }
        ...
        It 'ExecuteCommand Parameter Position is defined correctly' {
            [String]$Function.Parameters.ExecuteCommand.Attributes.Position | Should be '10'
            }
