Describe 'WriteWarning Tests' {

   Context 'Parameters for WriteWarning'{

        It 'Has a Parameter called Message' {
            $Function.Parameters.Keys.Contains('Message') | Should Be 'True'
            }
        It 'Message Parameter is Identified as Mandatory being False' {
            [String]$Function.Parameters.Message.Attributes.Mandatory | Should be 'False'
            }
