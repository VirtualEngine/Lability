Describe 'ExpandZipArchive Tests' {

   Context 'Parameters for ExpandZipArchive'{
        ...
        It 'Has a Parameter called ExcludeNuSpecFiles' {
            $Function.Parameters.Keys.Contains('ExcludeNuSpecFiles') | Should Be 'True'
            }
        It 'ExcludeNuSpecFiles Parameter is Identified as Mandatory being False' {
            [String]$Function.Parameters.ExcludeNuSpecFiles.Attributes.Mandatory | Should be 'False'
            }
        It 'ExcludeNuSpecFiles Parameter is of SwitchParameter Type' {
            $Function.Parameters.ExcludeNuSpecFiles.ParameterType.FullName | Should be 'System.Management.Automation.SwitchParameter'
            }
        It 'ExcludeNuSpecFiles Parameter is member of ParameterSets' {
            [String]$Function.Parameters.ExcludeNuSpecFiles.ParameterSets.Keys | Should Be '__AllParameterSets'
            }
        It 'ExcludeNuSpecFiles Parameter Position is defined correctly' {
            [String]$Function.Parameters.ExcludeNuSpecFiles.Attributes.Position | Should be '-2147483648'
            }
        It 'Does ExcludeNuSpecFiles Parameter Accept Pipeline Input?' {
            [String]$Function.Parameters.ExcludeNuSpecFiles.Attributes.ValueFromPipeline | Should be 'False'
            }
        It 'Does ExcludeNuSpecFiles Parameter Accept Pipeline Input by PropertyName?' {
            [String]$Function.Parameters.ExcludeNuSpecFiles.Attributes.ValueFromPipelineByPropertyName | Should be 'True'
            }
        It 'Does ExcludeNuSpecFiles Parameter use advanced parameter Validation? ' {
            $Function.Parameters.ExcludeNuSpecFiles.Attributes.TypeID.Name -contains 'ValidateNotNullOrEmptyAttribute' | Should Be 'False'
            $Function.Parameters.ExcludeNuSpecFiles.Attributes.TypeID.Name -contains 'ValidateNotNullAttribute' | Should Be 'False'
            $Function.Parameters.ExcludeNuSpecFiles.Attributes.TypeID.Name -contains 'ValidateScript' | Should Be 'False'
            $Function.Parameters.ExcludeNuSpecFiles.Attributes.TypeID.Name -contains 'ValidateRangeAttribute' | Should Be 'False'
            $Function.Parameters.ExcludeNuSpecFiles.Attributes.TypeID.Name -contains 'ValidatePatternAttribute' | Should Be 'False'
            }
        It 'Has Parameter Help Text for ExcludeNuSpecFiles '{
            $function.Definition.Contains('.PARAMETER ExcludeNuSpecFiles') | Should Be 'True'
            }
