Describe 'RenameModuleCacheVersion Tests' {

   Context 'Parameters for RenameModuleCacheVersion'{
        ...
        It 'Owner Parameter is member of ParameterSets' {
            [String]$Function.Parameters.Owner.ParameterSets.Keys | Should Be 'GitHub'
            }
        It 'Owner Parameter Position is defined correctly' {
            [String]$Function.Parameters.Owner.Attributes.Position | Should be '-2147483648'
            }
        ...
        It 'Branch Parameter is Identified as Mandatory being True' {
            [String]$Function.Parameters.Branch.Attributes.Mandatory | Should be 'True'
            }
        ...
        It 'Branch Parameter is member of ParameterSets' {
            [String]$Function.Parameters.Branch.ParameterSets.Keys | Should Be 'GitHub'
            }
        It 'Branch Parameter Position is defined correctly' {
            [String]$Function.Parameters.Branch.Attributes.Position | Should be '-2147483648'
            }
