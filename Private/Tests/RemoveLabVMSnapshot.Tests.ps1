Describe 'RemoveLabVMSnapshot Tests' {

   Context 'Parameters for RemoveLabVMSnapshot'{
        ...
        It 'SnapshotName Parameter is Identified as Mandatory being False' {
            [String]$Function.Parameters.SnapshotName.Attributes.Mandatory | Should be 'False'
            }
