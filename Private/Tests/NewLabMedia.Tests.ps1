Describe 'NewLabMedia Tests' {

   Context 'Parameters for NewLabMedia'{
        ...
        It 'Does Id Parameter Accept Pipeline Input?' {
            [String]$Function.Parameters.Id.Attributes.ValueFromPipeline | Should be 'False'
            }
        ...
        It 'Filename Parameter Position is defined correctly' {
            [String]$Function.Parameters.Filename.Attributes.Position | Should be '1'
            }
        ...
        It 'Description Parameter Position is defined correctly' {
            [String]$Function.Parameters.Description.Attributes.Position | Should be '2'
            }
        ...
        It 'Architecture Parameter is Identified as Mandatory being False' {
            [String]$Function.Parameters.Architecture.Attributes.Mandatory | Should be 'False'
            }
        ...
        It 'ImageName Parameter Position is defined correctly' {
            [String]$Function.Parameters.ImageName.Attributes.Position | Should be '4'
            }
        ...
        It 'Does ImageName Parameter use advanced parameter Validation? ' {
            $Function.Parameters.ImageName.Attributes.TypeID.Name -contains 'ValidateNotNullOrEmptyAttribute' | Should Be 'False'
        ...
        It 'MediaType Parameter is Identified as Mandatory being False' {
            [String]$Function.Parameters.MediaType.Attributes.Mandatory | Should be 'False'
            }
        ...
        It 'MediaType Parameter Position is defined correctly' {
            [String]$Function.Parameters.MediaType.Attributes.Position | Should be '5'
            }
        ...
        It 'Uri Parameter is Identified as Mandatory being False' {
            [String]$Function.Parameters.Uri.Attributes.Mandatory | Should be 'False'
            }
        ...
        It 'Uri Parameter Position is defined correctly' {
            [String]$Function.Parameters.Uri.Attributes.Position | Should be '6'
            }
        ...
        It 'ProductKey Parameter Position is defined correctly' {
            [String]$Function.Parameters.ProductKey.Attributes.Position | Should be '8'
            }
        ...
        It 'OperatingSystem Parameter Position is defined correctly' {
            [String]$Function.Parameters.OperatingSystem.Attributes.Position | Should be '9'
            }
        ...
        It 'CustomData Parameter Position is defined correctly' {
            [String]$Function.Parameters.CustomData.Attributes.Position | Should be '10'
            }
        ...
        It 'Hotfixes Parameter is of Array Type' {
            $Function.Parameters.Hotfixes.ParameterType.FullName | Should be 'System.Array'
            }
        ...
        It 'Hotfixes Parameter Position is defined correctly' {
            [String]$Function.Parameters.Hotfixes.Attributes.Position | Should be '11'
            }
        ...
        It 'Does Hotfixes Parameter use advanced parameter Validation? ' {
            ...
            $Function.Parameters.Hotfixes.Attributes.TypeID.Name -contains 'ValidateNotNullAttribute' | Should Be 'False'
