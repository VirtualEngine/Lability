Describe 'GetModuleCacheManifest Tests' {

   Context 'Parameters for GetModuleCacheManifest'{
        ...
        It 'Provider Parameter is Identified as Mandatory being False' {
            [String]$Function.Parameters.Provider.Attributes.Mandatory | Should be 'False'
            }
        ...
        It 'Provider Parameter is member of ParameterSets' {
            [String]$Function.Parameters.Provider.ParameterSets.Keys | Should Be '__AllParameterSets'
            }
        It 'Provider Parameter Position is defined correctly' {
            [String]$Function.Parameters.Provider.Attributes.Position | Should be '1'
            }
        It 'Does Provider Parameter Accept Pipeline Input?' {
            [String]$Function.Parameters.Provider.Attributes.ValueFromPipeline | Should be 'False'
            }
        It 'Does Provider Parameter Accept Pipeline Input by PropertyName?' {
            [String]$Function.Parameters.Provider.Attributes.ValueFromPipelineByPropertyName | Should be 'False'
            }
