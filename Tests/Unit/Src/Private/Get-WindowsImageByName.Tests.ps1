...
Describe 'Src\Private\Get-WindowsImageByIndex' {
    ...
    InModuleScope $moduleName {
        ...
        It 'Returns a "System.Int32" type' {
            ...
            $imageIndex = Get-WindowsImageByName -ImagePath $testWimPath -ImageName $testImageName;
        ...
        It 'Returns nothing when image index is not found' {
            ...
            $imageIndex = Get-WindowsImageByName -ImagePath $testWimPath -ImageName 'This should not exist';
